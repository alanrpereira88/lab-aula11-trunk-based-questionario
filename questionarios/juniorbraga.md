...
**Nome:** _Luciano Junior Bifano Braga_
**Data:** _29/05/2026_
**Turma:** DevOps I — 2025
...
_Fazer uma merge direto na main é um problema sério. Subir direto na main pode causar bugs inesperados, problemas de desenvolvimento e principalmente, vulnerabilidades que um simples commit na branch já resolve, pois pode ser verificada, testada e validada para subir na main. Além de que, com vários programadores trabalhando em um projeto não faz sentido subir na main e toda hora ter que atualizar projeto dando "git pull", é muito melhor cada um trabalhar em seu ambiente e pasta e depois "mergear" tudo._
...
_Principalmente revisão e comparação do código, o pull request protege o código de falhas que o programador pode não ter visto, fazendo com que outro "olho" veja de maneira diferente e valide o código escrito._
...
_O código sem validação subindo direto pra main ia matar todo mundo que desse git pull, por isso precisa existir automações que rodam por trás pra proteger esses códigos de subida rápida de quebrarem o sistema._
...
_Sem ela o desenvolvedor não poderia subir código sem estar pronto, ou seja, código incompleto. Com a feature flag ele pode subir código incompleto mas é protegido pela "invisibilidade" que a feature flag traz pra outros desenvolvedores. Em resumo, não quebra o código pois não vai para produção até a permissão ser concedida._
